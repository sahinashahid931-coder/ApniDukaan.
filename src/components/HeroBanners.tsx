  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4 pt-3 sm:pt-4">
      ...
      <div className="relative rounded-lg overflow-hidden shadow-md group">
        <div className={`w-full bg-gradient-to-r ${current.bgGradient} text-white transition-all duration-700 min-h-[190px] sm:min-h-[250px] md:min-h-[280px] flex items-center justify-between px-6 sm:px-12 py-6 relative`}>
          
          {/* Banner Text Content */}
          <div className="max-w-xl z-10 space-y-2 sm:space-y-3">
            ...
            <h2 className="text-xl sm:text-3xl md:text-4xl font-extrabold tracking-tight leading-tight text-white drop-shadow">
              {current.title}
            </h2>
            ...
            <div className="pt-1">
              <button
                ...
                className="bg-[#ffe500] hover:bg-yellow-300 text-slate-900 font-bold px-5 py-2 sm:py-2.5 rounded text-xs sm:text-sm transition-transform active:scale-95 shadow-md flex items-center gap-2 cursor-pointer"
              >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 mt-3">
        <div className="bg-white p-2.5 sm:p-3 rounded border border-slate-200 shadow-xs flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-full bg-emerald-50 text-[#0b8442] flex items-center justify-center flex-shrink-0">
            <ShieldCheck className="w-4 h-4" />
          </div>
          <div>
            <h4 className="text-xs font-bold text-slate-800">100% Authentic</h4>
            <p className="text-[10px] text-slate-500">Products directly from verified brands</p>
          </div>
        </div>
        ...
        <div className="bg-white p-2.5 sm:p-3 rounded border border-slate-200 shadow-xs flex items-center gap-2.5">
          ...
          <div>
            <h4 className="text-xs font-bold text-slate-800">Secure Payment</h4>
            <p className="text-[10px] text-slate-500">256-Bit SSL Encrypted Gateways</p>
          </div>
        </div>
        ...
        <div className="bg-white p-2.5 sm:p-3 rounded border border-slate-200 shadow-xs flex items-center gap-2.5">
          ...
          <div>
            <h4 className="text-xs font-bold text-slate-800">7-Day Easy Returns</h4>
            <p className="text-[10px] text-slate-500">Hassle-free instant pickup & refund</p>
          </div>
        </div>
        ...
        <div className="bg-white p-2.5 sm:p-3 rounded border border-slate-200 shadow-xs flex items-center gap-2.5">
          ...
          <div>
            <h4 className="text-xs font-bold text-slate-800">Fast Express Delivery</h4>
            <p className="text-[10px] text-slate-500">Next day delivery in 100+ cities</p>
          </div>
        </div>
      </div>
    </div>
